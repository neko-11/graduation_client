            ...
            <Layout style={{ minHeight: '100vh' }}>
                ...
                <Layout>
                    <Content className={style.ContentB}>
                        ...
                        {/*正文*/}
                        <div style={{ border:'1px solid #ddd', boxShadow:'0px 0px 4px #ccc',padding: 24, background: '#fff', minHeight: 360 }}>
                            ...
                            >
                                {
                                    leftconfig.map((data,index)=>{
                                        return(
                                            ...
                                            data.child.map((cdata,cindex)=>{
                                                return(
                                                    <Route key={ "router"+cindex } exact strict path={cdata.path} component={ AsyncComponent(cdata.component) } />
                                                )
                                            })
                                            :
